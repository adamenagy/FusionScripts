...
def main():
    ...
    try:
        ...
        result += '\n\n** Toolbar Panels (' + str(ui.toolbarPanels.count) + ')____\n'
        for panel in ui.toolbarPanels:
        ...
        if control.objectType == adsk.core.SeparatorControl.classType():
            ...
            if control.objectType == adsk.core.CommandControl.classType():
                ...
                if fullReport:
                    ...
                    try:
                        ...
                        if commandDef:
                            ...
                            msg += (((level+2)*3)*' ') + 'tooltip: ' + control.commandDefinition.tooltip + '\n'
                            msg += (((level+2)*3)*' ') + 'tooltipDescription: ' + control.commandDefinition.tooltipDescription + '\n'
                            ...
                            if controlDef.objectType == adsk.core.ButtonControlDefinition.classType():
                                ...
                                for listItem in controlDef.listItems:
                                    if listItem.isSeperator:
                                        msg += (((level+4)*3)*' ') + '-Seperator-\n'
                                    else:
                ...
                if fullReport:
                    ...
                    msg += (((level+1)*3)*' ') + '+ Additional associated controls not shown because of a bug.\n'
                    result += msg
                    # There is currently a bug with getting the definitions associated with a split button control.
                    #for cmdDef in control.additionalDefinitions:
                        #print((((level+1)*3)*' ') + cmdDef.id)
            else:
